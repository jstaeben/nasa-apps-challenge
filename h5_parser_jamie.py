...
# list to store the total brightness of each day to analyze later
brightness_list = []

# parse through h5 file and print total brightness temperature
def parseFile(filename, brightness_list):
    # start timer
    ...
    # add total brightness to list
    brightness_list.append(totalBrightness)


# go through each data file in our list and get its brightness temperature
print(data_file_list, brightness_list)
for data_file_name in data_file_list:
    parseFile(data_file_name, brightness_list)
